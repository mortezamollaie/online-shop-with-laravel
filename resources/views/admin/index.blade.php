  ...
  <body dir="rtl">
    <header class="header">
      <section class="sidebar-header bg-gray">
        <section
          class="d-flex justify-content-between flex-md-row-reverse px-2"
        >
          ...
          <span class="d-md-none pointer" id="menu-toggle"
        ...
        <section class="d-flex justify-content-between">
          <section>
            <span class="mr-5">
              ...
              <i
                id="search-toggle"
                class="fas fa-search p-1 d-none d-md-inline pointer"
              ></i>
            </span>
          ...
          <section>
            <span class="ml-2 ml-md-4 position-relative">
              ...
              <section
                ...
                class="header-notification rounded"
              >
                <section class="d-flex justify-content-between">
            ...
            <span class="ml-2 ml-md-4 position-relative">
              <span id="header-comment-toggle" class="pointer">
                <i class="far fa-comment-alt"
                  ><sup class="badge badge-danger">3</sup></i
                >
                        ...
                        <section class="media">
                          ...
                          <section class="media-body pr-1">
                            <section class="d-flex justify-content-between">
                              ...
                              <span
                                ><i
                                  class="fas fa-circle text-success comment-user-status"
                                ></i
                              ></span>
                            </section>
                          </section>
              ...
              <section id="header-profile" class="header-profile rounded">
                <section class="list-group rounded">
                  <a
                    ...
                    ><i class="fas fa-cog"></i>تنظیمات</a
                  >
                  <a
                    href="#"
                    class="list-group-item list-group-item-action header-profile-link"
                    ><i class="fas fa-user"></i>کاربر</a
                  >
                  <a
                    href="#"
                    class="list-group-item list-group-item-action header-profile-link"
                    ><i class="far fa-envelope"></i>پیام ها</a
                  >
                  <a
                    href="#"
                    class="list-group-item list-group-item-action header-profile-link"
                    ><i class="fas fa-lock"></i>قفل صفحه</a
                  >
                  <a
                    href="#"
                    class="list-group-item list-group-item-action header-profile-link"
